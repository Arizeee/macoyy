                ...
                <form action="/insertgame" method="POST" enctype="multipart/form-data">
                    <table id="tbl-card">
                        @csrf
                            ...
                            <tr>
                                <td>Game</td>
                                <td><input type="text" name="nama_game" required="required" placeholder="Nama" style="width: 250px;"></td>
                            </tr>
                            <tr>
                                <td>Versi Game</td>
                                <td><input type="text" name="versi_game" required="required" placeholder="Username" style="width: 250px;"></td>
                            </tr>
                            <tr>
                                <td>
