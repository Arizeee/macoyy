    ...
    <div class="home-content">
      ...
      <div class="sales-boxes">
        <div class="recent-sales box">
          ...
          <a href="/guru/tambahguru"  class="btn btn-success mt-2 mb-2">Tambah</a>
            <div class="table-sect">
                <table>
                    ...
                    <tbody>
                        ...
                        <td>{{ $rows->nip }}</td>
                        <td>{{ $rows->mata_pelajaran }}</td>
                    <td>{{ $rows->jenis_kelamin }}</td>
                    <td>
                      <a href="/editguru/{{ $rows->id }}" class="btn btn-success"><i class='bx bxs-edit'></i></a>
                      <a href="/hapusguru/{{ $rows->id }}" class="btn btn-danger"><i class='bx bx-trash-alt' ></i></a>
                    </td>
                  </tr>
                    @endforeach
                    </tbody>
