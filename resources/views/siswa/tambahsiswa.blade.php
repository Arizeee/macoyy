                        ...
                        <form action="/insertsiswa" method="POST">
                            ...
                            <div class="mb-3">
                              ...
                              <div class="mb-3">
                                ...
                                <input type="string" name="no_telp" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                              </div>
                            <div class="mb-3">
                                ...
                                <select class="form-select mb-4" name="kelas_id" aria-label="Default select example">
                                    <option selected>Pilih Kelas & Jurusan</option>
                                    @foreach ($kelas_jurusan as $kj)
