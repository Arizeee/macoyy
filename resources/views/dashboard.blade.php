...
<body>
  <div class="sidebar close">
    ...
    <div class="profile-details">
      <div class="profile-content">
        <img src="assets/images/Kazuha.jpg" alt="profileImg">
      </div>
      <div class="name-job">
  ...
  <section class="home-section">
    ...
    <div class="topright">
      <ul>
        <li>Kazuhaaa</li>
        <li><img src="assets/images/Kazuha.jpg" alt="profileImg"></li>
    ...
    <div class="contain-2">
     ...
     <table id="tbl">
      ...
      <tr>
        <td>
          <img src="assets/images/Kazuha.jpg" alt="" style="width: 50px; height: 50px; border-radius: 50%;">
        </td>
        <td>Name</td>
        <td>Username</td>
        <td>Game</td>
        <td>
          <button  class="btn-2" style="margin-left: -30px;"> <a href='#'><iconify-icon icon="uil:trash"></iconify-icon></a></button>
        </td>
      </tr>
