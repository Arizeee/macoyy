                ...
                <form action="/updatedata/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                    <table id="tbl-card">
                        @csrf
                            ...
                            <tr>
                                <td>Nama</td>
                                <td><input type="text" name="name" required="required" value="{{ $data->name}}" style="width: 250px;"></td>
                            </tr>
                            <tr>
                                <td>Username</td>
                                <td><input type="text" name="username" required="required" value="{{ $data->username}}" style="width: 250px;"></td>
                            </tr>
                            <tr>
                                <td>Keterangan</td>
                                <td><input type="text" name="keterangan" required="required" value="{{ $data->keterangan}}" style="width: 250px;"></td>
                            </tr>
                            <tr>
                                <td>
