    ...
    <div class="home-content">
      ...
      <div class="sales-boxes">
        <div class="recent-sales box">
          <div class="title">Data Pelanggaran</div>
          <a href="/tambahpelanggaran"  class="btn btn-success mt-2 mb-2">Tambah</a>
            <div class="table-sect">
                <table>
                    ...
                    <tbody>
                        @foreach ($pelanggaran as $rows)
                        <tr>
                            <td>{{ $rows->id }}</td>
                            <td>{{ $rows->bentuk_pelanggaran}}</td>
                            <td>{{ $rows->jenis_pelanggaran}}</td>
                            <td>{{ $rows->sanksi}}</td>
                            <td>{{ $rows->poin}}</td>
                            <td>
                            <a href="/editpelanggaran/{{ $rows->id }}" class="btn btn-success"><i class='bx bxs-edit'></i></a>
                            <a href="/hapuspelanggaran/{{ $rows->id }}" class="btn btn-danger"><i class='bx bx-trash-alt' ></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
