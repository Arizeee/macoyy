            ...
            @csrf
              <div class="row">
                ...
                <div class="input-group col-lg-12 mb-4">
                  ...
                  <input id="user" type="text"  class="form-control bg-white border-left-0 border-md" placeholder="Please enter your name" name="name" value="{{old('name')}}">
                  ...
                  <div class="input-group col-lg-12 mb-4">
                      ...
                      {{-- <input id="email" type="email" name="email" placeholder="Email Address" class="form-control bg-white border-left-0 border-md"> --}}
                      <label for="user" class="label"></label>
                      <input id="user" type="email"  class="form-control bg-white border-left-0 border-md" placeholder="Please enter your email" name="email" value="{{old('email')}}">
                      <span style="color: red">
                        @error('email')
                          {{ $message }}
                        @enderror
